...
StackManager_dispTab:
	...
	.word	A2I.i2a
	.word	A2I.i2a_aux
	.word	StackManager.init
	.word	StackManager.push
	.word	StackManager.top
	.word	StackManager.isEmpty
	.word	StackManager.pop
	.word	StackManager.evaluate
	.word	StackManager.getContentsHelper
	.word	StackManager.getContents
Stack_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
...
label111:
	...
	addiu	$sp $sp 28
	jr	$ra	
StackManager.getContentsHelper:
	addiu	$sp $sp -12
	sw	$fp 12($sp)
	sw	$s0 8($sp)
	sw	$ra 4($sp)
